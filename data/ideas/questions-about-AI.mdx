...
4. [Llama3 8b is nearly as powerful as Llama2 70B. Will we see a useful 1B model that performs as well as 7-20B models soon?](#llama3-8b-is-nearly-as-powerful-as-llama2-70b-will-we-see-a-useful-1b-model-that-performs-as-well-as-7-20b-models-soon)
...
GPT-4, Opus and similar models were trained on vast amounts of the world’s public data. What percentage of all usable data does their training set amount to? My intuition says low-double-digit percentage points. Another question would be how much high-quality data exists in the world; my suspicion is GPT-4’s training set is a significantly larger percentage of that number. What are the major untapped data siloes? Is somebody keeping a list of them somewhere? Examples:
...
### Is there a Moore's Law equivalent for model capabilites? <a name="is-there-a-moores-law-equivalent-for-model-capabilites" />
